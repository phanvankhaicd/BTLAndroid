...
-- Dumping data for table ncovi-hdv.health_monitor: ~2 rows (approximately)
...
-- Dumping data for table ncovi-hdv.hibernate_sequence: 3 rows
...
-- Dumping data for table ncovi-hdv.notification: ~0 rows (approximately)
...
-- Dumping data for table ncovi-hdv.reflection: ~0 rows (approximately)
/*!40000 ALTER TABLE `reflection` DISABLE KEYS */;
INSERT INTO `reflection` (`reflection_id`, `reflection_contact_question_1`, `reflection_contact_question_2`, `reflection_contact_question_3`, `reflection_info_question_1`, `reflection_info_question_2`, `reflection_info_question_3`, `reflection_info_description`, `reflection_info_time`, `reflection_type`, `reflection_created_at`, `user`) VALUES
	(1, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, 1, '2020-06-13 17:58:54.257000', 12),
	(2, NULL, NULL, NULL, 0, 1, 1, 'ahihi do\' ngok', '2020-06-13 17:58:54', 0, '2020-06-13 18:02:16.536000', 12),
	(3, 1, 1, 0, NULL, NULL, NULL, NULL, NULL, 1, '2020-06-13 18:05:25.050000', 12),
	(4, NULL, NULL, NULL, 0, 1, 1, 'ahihi do\' ngok', '2020-06-13 17:58:54', 0, '2020-06-13 18:05:54.865000', 12);
...
INSERT INTO `user` (`user_id`, `user_email`, `user_fullname`, `user_birthday`, `user_address`, `user_phone_no`, `user_cmt`, `user_bhxh`, `user_gender`, `user_created_at`, `role`, `user_device_token`) VALUES
	(6, 'tung@gmail.com', 'Hoang Manh Tung', '2020-06-12', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL),
	(12, 'duc123@gmail.com', 'Pham Minh Duc', '2020-06-12', 'ha Noi', '0395592104', '1724595952', '123123123', 0, NULL, 2, NULL);
